...
class PolymarketConfig:
    ...
    series_slugs_hourly: Dict[str, str] = field(
        default_factory=lambda: {
...
class StrategyConfig:
    ...
    min_abs_return_pct: float = 0.0015
    max_entry_price: float = 0.9
    fee_estimate: float = 0.01
    min_edge: float = 0.005
    min_time_to_end_minutes: float = 1.0
    max_time_to_end_minutes: float = 60.0
    volatility_mult: float = 1.5
    trade_cooldown_seconds: float = 180.0
...
class AppConfig:
    ...
    paper_max_fraction_per_trade: float = 0.5
    paper_max_open_orders: int = 3
